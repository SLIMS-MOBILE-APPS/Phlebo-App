...
class Phlebo_Transaction_update extends StatefulWidget {
  @override
  _Phlebo_Transaction_update createState() => _Phlebo_Transaction_update();
}

class _Phlebo_Transaction_update extends State<Phlebo_Transaction_update> {
...
//discount drowpdwon
  ...
  void Pay_Function(BuildContext context) async {
    Map<String, dynamic> data = {
      ...
      "paid_amnt": (globals.PAID_AMOUNT_VALIDATION != "0.0")
          ? globals.total_price
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  (globals.PAID_AMOUNT_VALIDATION != "0.0")
                      ? Container(
                          height: screenHeight * 0.3, child: function_widet())
                      : Container(
