...
class Phlebo_Transaction_by_New_Order extends StatefulWidget {
  @override
  _Phlebo_Transaction_by_New_Order createState() =>
      _Phlebo_Transaction_by_New_Order();
}

class _Phlebo_Transaction_by_New_Order
    extends State<Phlebo_Transaction_by_New_Order> {
  ...
  void Completed_Function(BuildContext context) async {
    ...
    Map<String, dynamic> data = {
      ...
      "serviceid": globals.SERVICE_ID_by_new_order_with_all_Service_id,
